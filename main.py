...
def main():
    ...
    print("This program analyzes the probability of consecutive bull/bear moves")
    print("based on historical data with customizable timeframes and periods.\n")
    
    while True:
        # Get user inputs
        ticker = input("Enter a stock ticker symbol: ").strip().upper()
        ...
        if continue_analysis not in ['y', 'yes']:
            print("Thank you for using Timeframe Close Probability!")
            break
